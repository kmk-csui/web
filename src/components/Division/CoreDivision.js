...
export default function CoreDivision() {
    return (
        <div className="CoreDivision">
            ...
            <CoreDivisionMember position="Koordinator Fakultas" name="Cornelita Lugita Santoso" image={KETUA} pos="left" />
            <CoreDivisionMember position="Wakil Koordinator Fakultas" name="Dionisius Baskoro Samudra" image={WAKIL} pos="right" />
            <CoreDivisionMember position="Sekretaris" name="Francis Wibisono" image={SEKRETARIS} pos="left" />
            <CoreDivisionMember position="Wakil Sekretaris" name="Marta Junike Dewi Anugrah" image={BENDAHARA} pos="right" />
        </div>
    )
}
